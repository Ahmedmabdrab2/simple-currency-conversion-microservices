...
* The original package name 'com.aadeveloping.microservices.naming- server' is invalid and this project uses 'com.aadeveloping.microservices.naming.server' instead.
